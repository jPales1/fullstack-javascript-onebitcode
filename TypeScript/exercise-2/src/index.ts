...
function changeSituation(newSituation: Situation, planet: Planet) {
...
function addSatellite(newSatellite: string, planet: Planet) {
...
function removeSatellite(removeSatellite: string, planet: Planet) {
...
function validPlanet(callbackfn: (planet: Planet) => void) {
