...
function addMember(newMember: string, spaceship: { name: string, crew: string[], crewLimit: number }) {
...
function sendMission(spaceship: { name: string, crew: string[], crewLimit: number, inMission: boolean }) {
